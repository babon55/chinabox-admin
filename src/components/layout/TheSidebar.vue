...
const navItems = computed<NavItem[]>(() => [
  ...
  { key: 'orders',    label: { tk: 'Sargytlar',         ru: 'Заказы'            }, icon: 'orders',    path: '/orders',  badge: 12  },
...
.logo-mark {
  ...
  color: #fff; box-shadow: 0 4px 12px var(--gold-shadow);
}
...
.collapse-btn {
  display: flex; align-items: center; gap: 11px;
  margin: 0 8px 12px; padding: 9px 10px; border-radius: var(--radius-md);
